...
export namespace Sync {
     ...
     *
     * See also {@link EnhancedAsyncGenerator | Async.Generator}
     */
     ...
     * this returns a class that implements {@link IEnhancements}, allowing
     * one to treat it as if it were an array, in supporting methods such as
     * {@link IEnhancements.map | .map()} and {@link IEnhancements.filter | .filter()}.
     *
     * Usage:
     *
     * ```typescript
